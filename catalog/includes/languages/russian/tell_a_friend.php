...
define('NAVBAR_TITLE', 'Рассказать другу');

define('HEADING_TITLE', 'Рассказать другу о \'%s\'');
...
define('TEXT_EMAIL_LINK', 'Чтобы посмотреть этот товар, кликните, пожалуйста, на ссылку ниже или скопируйте и вставьте ссылку в Ваш браузер:' . "\n\n" . '%s');
...
define('ERROR_ACTION_RECORDER', 'Ошибка: Письмо уже отослано. Пожалуйста попробуйте ещё раз через %s минут.');
