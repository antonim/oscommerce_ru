...
define('BOX_INFORMATION', 'Мы проверяем SSL идентификатор сессии автоматически сгенерированный для Вашего браузера на каждой защищённой странице, запрашиваемой на нашем сервере.<br><br>Эта проверка делается для того, чтобы удостовериться что это именно Вы, а никто другой.');
