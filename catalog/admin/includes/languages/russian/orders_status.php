...
define('TABLE_HEADING_ORDERS_STATUS', 'Статусы заказов');
define('TABLE_HEADING_PUBLIC_STATUS', 'Статус публикации');
...
define('TEXT_SET_PUBLIC_STATUS', 'Показывать заказ покупателю при этом статусе заказа');
define('TEXT_SET_DOWNLOADS_STATUS', 'Разрешить загрузку виртуальных товаров в заказе при этом статусе заказа');
