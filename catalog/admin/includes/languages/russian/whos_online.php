...
define('TABLE_HEADING_ONLINE', 'Онлайн');
...
define('TEXT_SHOPPING_CART_SUBTOTAL', 'Стоимость товара');
define('TEXT_NUMBER_OF_CUSTOMERS', 'На данный момент в магазине покупателей: %s');
