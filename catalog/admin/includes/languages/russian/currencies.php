...
define('WARNING_PRIMARY_SERVER_FAILED', 'Предупреждение: Не удалось подключиться к серверу (%s) и обновить обменный курс для %s (%s) - попробуйте подключиться к другому серверу. Чтобы обновить обменный курс, Вы должны быть подключены к интернету.');