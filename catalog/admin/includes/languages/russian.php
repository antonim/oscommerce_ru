...
define('BOX_CONFIGURATION_ADMINISTRATORS', 'Администраторы');
...
define('BOX_REPORTS_ORDERS_TOTAL', 'Лучшие покупатели');

// tools text in includes/boxes/tools.php
define('BOX_HEADING_TOOLS', 'Инструменты');
define('BOX_TOOLS_ACTION_RECORDER', 'Запись действий');
...
define('BOX_TOOLS_SEC_DIR_PERMISSIONS', 'Безопасность прав директорий');
...
define('TEXT_DISPLAY_NUMBER_OF_CUSTOMERS', 'Показано <b>%d</b> - <b>%d</b> (всего <b>%d</b> покупателей)');
define('TEXT_DISPLAY_NUMBER_OF_CURRENCIES', 'Показано <b>%d</b> - <b>%d</b> (всего <b>%d</b> валют)');
define('TEXT_DISPLAY_NUMBER_OF_ENTRIES', 'Показано <strong>%d</strong> - <strong>%d</strong> (всего <strong>%d</strong> записей)');
...
define('WARNING_NO_FILE_UPLOADED', 'Предупреждение: Новые файлы не загружены.');